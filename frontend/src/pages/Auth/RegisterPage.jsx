...
import { BrainCircuit, Mail, Lock, User, ArrowRight, Eye, EyeOff, CheckCircle } from 'lucide-react';
                            ...
                            <>
                                ...
                                <div className="text-center mb-7">
                                    <motion.div
                                        ...
                                        className="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-gradient-to-br from-emerald-400 to-teal-500 shadow-xl shadow-emerald-500/30 mb-5"
                                    >
